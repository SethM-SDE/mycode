...
def get_ip_data():
    ...
    input_name = input("What is the name of this device? ")
    input_location = input("Where is it located? ")
    d = {"IP": input_ip, "driver": input_driver, "name": input_name, "location": input_location}
    return d
